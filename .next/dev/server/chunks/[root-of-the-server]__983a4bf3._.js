...
async function handler(req, res) {
    ...
    if (req.method === "POST") {
        ...
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$helper$2f$db$2d$util$2e$js__$5b$api$5d$__$28$ecmascript$29$__["InsertDocument"])(client, {
                email: enteredEmail
            }, "newsletterEmails");
            res.status(201).json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__983a4bf3._.js.map