...
function TripDetailPage(props) {
    ...
    if ($[0] !== "98c6a5d535eceb8a1ec27df40d4cf5176085d9c02477799e8270346f32781a0a") {
        for(let $i = 0; $i < 4; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "98c6a5d535eceb8a1ec27df40d4cf5176085d9c02477799e8270346f32781a0a";
    }
...
async function getStaticprops(context) {
    ...
    const { Id } = params;
    const destiantion = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$data$2e$js__$5b$client$5d$__$28$ecmascript$29$__["getDestinationById"])(Id);
    return {
        props: {
...
async function getStaticpaths() {
    const destinations = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$helper$2f$data$2d$util$2e$js__$5b$client$5d$__$28$ecmascript$29$__["getAllDestination"])();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__444a28ad._.js.map