...
class NodeViewDesc extends ViewDesc {
    ...
    updateChildren(view, pos) {
        ...
        iterDeco(this.node, this.innerDeco, (widget, i, insideNode)=>{
            ...
            else if (widget.type.side >= 0 && !insideNode) updater.syncToMarks(i == this.node.childCount ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$model$2f$dist$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Mark"].none : this.node.child(i).marks, inline, view, i);
...
editHandlers.compositionstart = editHandlers.compositionupdate = (view)=>{
    if (!view.composing) {
        ...
        if (state.selection instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$state$2f$dist$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["TextSelection"] && (state.storedMarks || !$pos.textOffset && $pos.parentOffset && $pos.nodeBefore.marks.some((m)=>m.type.spec.inclusive === false) || chrome && windows && selectionBeforeUneditable(view))) {
...
//# sourceMappingURL=node_modules_prosemirror-view_dist_index_bb4e2544.js.map